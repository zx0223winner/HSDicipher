...
def main(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            print('add_HSD.py -i <inputfile> -a <adding_file> -o <output file>')
            print(
                'or use HSDFinder.py --input_file=<input file> --adding_file=<adding_file> --output_file=<output '
                'file>\n '
    ...
    if input_file == "" or adding_file == "":
        print("no input file or no adding file.")
        sys.exit(2)
    else:
